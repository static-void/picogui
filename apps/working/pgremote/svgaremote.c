/* $Id: svgaremote.c 3978 2003-05-23 10:19:38Z micah $
 *
...
/* This is basically a wrapper around the normal input driver code above */
...
int main(int argc,char **argv) {
   ...
   gl_write(5,5,"PicoGUI Remote Control");
   
   for (;;) {
      FD_ZERO(&readfd);
      svgainput_fd_init(&n,&readfd,NULL);
      if (select(n,&readfd,NULL,NULL,NULL)!=1)
	break;
      mouse_update();
      keyboard_update();
   }
