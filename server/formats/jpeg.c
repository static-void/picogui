/* $Id: jpeg.c 3978 2003-05-23 10:19:38Z micah $
 *
...
void jpeg_mem_src_pg (j_decompress_ptr cinfo, unsigned char  *inbuf, int size)
{
...
g_error jpeg_load(hwrbitmap *hbmp, const u8 *data, u32 datalen) {
  ...
  jpeg_mem_src_pg(&cinfo, (unsigned char *) data, datalen);  
